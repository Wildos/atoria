...
RULESET["item"] = class ItemRuleset {
  ...
  static getSavesAsked(item) {
    return item.system.saves_asked ?? [];
  }
...
RULESET["status_effects"] = [
  ...
  {
    id: "shattered",
    name: "ATORIA.Ruleset.Status_effect.Shattered.Label",
    img: "systems/atoria/imgs/cracked-shield.svg",
    description: "ATORIA.Ruleset.Status_effect.Shattered.Description",
  },
  {
    id: "brutal",
  ...
  {
    id: "maimed",
    name: "ATORIA.Ruleset.Status_effect.Maimed.Label",
    img: "systems/atoria/imgs/broken-skull.svg",
    description: "ATORIA.Ruleset.Status_effect.Maimed.Description",
  },
  {
    id: "panic",
  ...
  {
    id: "petrified",
    name: "ATORIA.Ruleset.Status_effect.Petrified.Label",
    img: "systems/atoria/imgs/static-guard.svg",
    description: "ATORIA.Ruleset.Status_effect.Petrified.Description",
  },
  {
    id: "preparing",
