...
export default class AtoriaFeatureItem extends atoria_models.AtoriaItemBase {
    ...
    static defineSchema() {
        ...
        schema.use_color = new fields.BooleanField({ required: true, nullable: false, initial: false, label: "ATORIA.Model.Color.Use_color" });
        schema.color = new fields.ColorField({ required: true, nullable: false, initial: "#000000", label: "ATORIA.Model.Color.Label" });
